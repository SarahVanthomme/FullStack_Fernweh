...
class ProductSeeder extends Seeder
{
    ...
    {
        //
        DB::table('products')->insert(['category_id'=>'1', 'continent_id'=>'1','country_id'=>'1','city_id'=>'1','photo_id'=>'1','name'=>'TRAVEL GUIDE MARRAKESH', 'description'=>'Description Marrakesh', 'price'=>'20.00']);
